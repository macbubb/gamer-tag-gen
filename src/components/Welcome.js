...
const Welcome = (props) => {
  ...
  return (
    <div style={popupStyle} ref={wrapperRef} className="welcome">
      <div className="close">
        <button aria-label="Close Welcome Popup" onClick={props.togglePopup}>
          <span>&#10005;</span>
        </button>
      </div>
      <h1>Need a gamertag?</h1>
      ...
      <h2>Get Started</h2>
      <p>
        Exit this intro by pressing <strong>ESC</strong> or the{' '}
        <strong>&#10005;</strong> in the top right corner.
      </p>
      <p>
        Press the <strong>CREATE</strong> button to make a new tag. Make as many
        as you like.
...
>>>>>>> 4e1596912ae5772e39d3de315c776f3a69999e6f
